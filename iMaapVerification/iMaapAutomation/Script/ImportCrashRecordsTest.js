...
var ImportPage=require("ImportPage");
 ...
 function ImportCrashDataTest() {
   ...
   ImportPage.ImportCrashRecords("Casualties",Project.Variables.importCasualityPath);
   ImportPage.VerifyImportedFile(Project.Variables.viewCasualtyActualRecord,"Casualties");
